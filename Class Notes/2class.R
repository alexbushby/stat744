...
print (plot_grid(direct.label(gg1)))
##i want hue (gives colours)
...
print(gg3)
##Rauser brought up a good point about the gridlines and how one should be careful with them. The default for these three graphs have been a nice faint line, using a package, so I haven't had to change that.
